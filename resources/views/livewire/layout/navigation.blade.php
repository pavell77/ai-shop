...
<nav x-data="{ open: false }" 
    ...
    {{-- Єдиний Livewire компонент, який тепер гарантовано оновлює Alpine стор при завантаженні сторінки --}}
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="me-4 flex items-center">
                    <a href="/cart" wire:navigate class="relative inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
